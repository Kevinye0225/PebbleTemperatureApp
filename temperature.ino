...
//        Serial.print(inputString);
        ...
        if (inputString[inputString.length()-2] == 'c'){
          isFahrenheit = false;
          Decimal2 = (inputString.substring(split+1,split+3).toInt())*100;
        } else {
          isFahrenheit = true;
          Decimal2 = inputString.substring(split+1,split+5).toInt();
        }
      
      byte Temperature_H2 = (byte)inputString.substring(0,split).toInt();
      stringComplete = false;
//      isFahrenheit = true;
      Dis_7SEG (Decimal2, Temperature_H2, Temperature_L, IsPositive);
      isFahrenheit = false;
      inputString = "";
      }
